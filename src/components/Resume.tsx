    ...
    <section id="resume" className="resume-section">
      <div className="resume-container">
        ...
        >
          ...
          >
            📚 B.Tech — Electrical with Computer Science<br />
            📍 Agra, Utter Pradesh, India<br />
            📩 tyagivivank1@gmail.com 
          </motion.p>
          ...
          >
            Aspiring Software Developer with AI skills, 
            building impactful solutions with Python and 
        ...
        >
          ...
          <div className="resume-list">
            {[
              {
                degree: "B.Tech in Electrical with Computer Science",
                school: "Dayalbagh Educational Institute",
                period: "2023 – 2027",
                detail: "Current GPA: 8.37",
              },
              {
                degree: "Higher Secondary (12th)",
                school: "REI Intermediate College",
                period: "2022 – 2023",
                detail: "8.9 cgpa",
              },
              {
        ...
        >
          ...
          <ul className="project-list">
            {[
              "- AI-Driven Rural Healthcare Platform ",
        ...
        >
          ...
          <div className="skill-tags">
            {[
              "Python","C","C++","Java","PyTorch","OpenCV",
              "Scikit-learn","YOLO","React","MySQL","Redis","LLM",
              "MongoDB","NLP","ML","DL","Creativity","Teamwork"
            ].map((skill, i) => (
              <motion.span
                key={skill}

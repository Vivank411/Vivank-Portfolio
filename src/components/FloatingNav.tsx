...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Vivank411', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/vivank-tyagi-81907127b/', label: 'LinkedIn' },
    ...
    { icon: Mail, href: 'mailto:tyagivivank1@gmail.com', label: 'Email' },
  ];

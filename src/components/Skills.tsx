...
const SKILLS = [
  ...
  { name: "LLM", logo: "https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg" },
];
  ...
  [
    {
      title: "Core Concepts",
      items: [
        { name: "Data Structures & Algorithms", level: 35 },
        { name: "Machine Learning", level: 85 },
        { name: "Deep Learning", level: 80 },
        { name: "YOLO Object Detection", level: 80 },
        { name: "LLMs & Generative AI", level: 80 },
      ],
    },
    {
      title: "Soft Skills",

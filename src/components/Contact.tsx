...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "tyagivivank1@gmail.com" },
    { icon: MapPin, label: "Location", value: "Agra, Utter Pradesh, India" },
  ];

 const quickLinks = [
  { icon: Github, url: "https://github.com/Vivank411" },
  { icon: Linkedin, url: "https://www.linkedin.com/in/vivank-tyagi-81907127b/" },
  { icon: Mail, url: "mailto:tyagivivank1@gmail.com" },
];
